...
SCILIB int ClearBuffer(void *buffer_handle)
{
	...
	return 0;
}SCILIB int REG_ManualTrigger_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_ManualTrigger, handle);
}
SCILIB int REG_ManualTrigger_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_ManualTrigger, handle);
}
SCILIB int REG_EnExternalTrigger_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_EnExternalTrigger, handle);
}
SCILIB int REG_EnExternalTrigger_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_EnExternalTrigger, handle);
}
SCILIB int REG_Threshold0_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_Threshold0, handle);
}
SCILIB int REG_Threshold0_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_Threshold0, handle);
}
SCILIB int REG_Polarity0_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_Polarity0, handle);
}
SCILIB int REG_Polarity0_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_Polarity0, handle);
}
SCILIB int REG_EnTrigger0_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_EnTrigger0, handle);
}
SCILIB int REG_EnTrigger0_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_EnTrigger0, handle);
}
SCILIB int REG_TimingReset_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_TimingReset, handle);
}
SCILIB int REG_TimingReset_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_TimingReset, handle);
}
SCILIB int REG_CounterEnable_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_CounterEnable, handle);
}
SCILIB int REG_CounterEnable_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_CounterEnable, handle);
}
SCILIB int REG_CounterReset_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_CounterReset, handle);
}
SCILIB int REG_CounterReset_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_CounterReset, handle);
}
...
SCILIB int LISTMODULE_Digitizer_0_START(NI_HANDLE *handle)

{
int r1 = __abstracted_reg_write(2,SCI_REG_Digitizer_0_CONFIG, handle);
int r2 = __abstracted_reg_write(1,SCI_REG_Digitizer_0_CONFIG, handle);
if ((r1 == 0) && (r2 == 0))
    return 0;
else
    return -1;
